...
public class GlobalException {
    ...
    // qualquer outro erro não previsto cai aqui como rede de segurança. Loga
    // completo (com stack trace) no servidor, mas nao devolve ex.getMessage()
    // pro cliente — isso vazaria detalhe interno (nome de tabela, campo, etc.).
